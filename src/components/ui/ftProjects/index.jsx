...
export default function FeaturedProject({ title, description, imgSrc, technologies, liveSiteLink, gitRepoLink  }) {
    return (
        <div className="md:w-full flex flex-col lg:flex-row-reverse md:transition md:hover:-translate-y-3 md:hover:translate-x-3 md:hover:shadow-lg md:hover:shadow-teal-400 md:duration-300 border-2 border-blueblack rounded-xl p-5 shadow-md">
            {/* img container */}
